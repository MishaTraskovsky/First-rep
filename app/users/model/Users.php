...
class Users extends Model{
    ...
    public function add_users_person_data(){
        ...
        public function ins_users_person_data_sql() {
            $stmt = self::$db->prepare("INSERT INTO `users_person_data`(`password`, `phone`, `phone_token`, `phone_token_data`, `doc_photo`, `surname`, `name`, `patronymic`, `date_of_birth`, `gender`, `other_data`) VALUES (:password, :phone, :phone_token, :phone_token_data, :doc_photo, :name, :patronymic, :date_of_birth, :gender, :other_data)");
