$(document).ready(function(){
 ...
 success: function ( data) {
                        ...
                        for (var i = 0; i < data.result.length; i++) {
                                html += '<tbody><tr><td>' + data.result[0].id + '</td><td>' + data.result[0].id_card + '</td><td>' + data.result[0].password + '</td><td>' + data.result[0].phone +'</td><td>' + data.result[0].phone_token + '</td><td>' + data.result[0].phone_token_data + '</td><td>' + data.result[0].doc_photo + '</td><td>' + data.result[0].surname '</td><td>' + data.result[0].name + '</td><td>' + data.result[0].patronymic + '</td><td>' + data.result[0].date_of_birth + '</td><td>' + data.result[0].gender + '</td><td>' +  data.result[0].other_data + '</td></tr></tbody>';
                        }
